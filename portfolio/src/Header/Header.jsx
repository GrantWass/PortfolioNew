    ...
    <header className={styles.container}>
      ...
      <div className={styles.imgContactContainer}>
        ...
        <div className={styles.iconsContainer}>
          <a href="https://github.com/GrantWass" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile">
            <FaGithub className={`${styles.icon} ${styles.iconGithub}`} />
          </a>
          <a href="https://www.linkedin.com/in/grant-wass/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile">
            <FaLinkedin className={`${styles.icon} ${styles.iconLinkedin}`} />
          </a>
          <a href="https://www.instagram.com/gran_t12/" target="_blank" rel="noopener noreferrer" aria-label="Instagram profile">
            <FaInstagram className={`${styles.icon} ${styles.iconInstagram}`} />
          </a>
          <a href="https://www.strava.com/athletes/39084065" target="_blank" rel="noopener noreferrer" aria-label="Strava profile">
            <FaStrava className={`${styles.icon} ${styles.iconStrava}`} />
          </a>
          <a href="/Resume_2025.pdf" target="_blank" rel="noopener noreferrer" aria-label="View resume">
